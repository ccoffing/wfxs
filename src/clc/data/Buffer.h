...
public:
    ...
    Buffer &IReplace(char replaceThis, char withThis, unsigned int maxReplaceCount, size_t fromOffset = 0);
    ...
    Buffer &IReplaceAll(const char *replaceThis, const char *withThis, size_t fromOffset = 0);
    Buffer &IReplace(const char *replaceThis, const char *withThis, unsigned int maxReplaceCount, size_t fromOffset = 0);
