...
Buffer &Buffer::remove(size_t from, size_t len)
{
...
int Buffer::ICompare(const Buffer &string) const
{
    return strcasecmp(c_str(), string.c_str());
}

int Buffer::ICompare(const char *string) const
{
    return strcasecmp(c_str(), safestr(string));
}

int Buffer::ICompare(const Buffer &string, size_t len) const
{
    return strncasecmp(c_str(), string.c_str(), len);
}

int Buffer::ICompare(const char *string, size_t len) const
{
...
size_t Buffer::IFindFirst(const Buffer &string) const
{
    return _IFindAfter(string.c_str(), 0, string.length());
}

size_t Buffer::IFindFirst(const char *string) const
{
    assert(string);
    return _IFindAfter(string, 0, strlen(safestr(string)));
}

size_t Buffer::IFindFirst(const Buffer &string, size_t fromOffset) const
{
    return _IFindAfter(string.c_str(), min_clamp0(fromOffset, length()), string.length());
}

size_t Buffer::IFindFirst(const char *string, size_t fromOffset) const
{
    assert(string);
    return _IFindAfter(string, min_clamp0(fromOffset, length()), strlen(safestr(string)));
}

size_t Buffer::IFindLast(const Buffer &string) const
{
    return _IFindBefore(string.c_str(), length(), string.length());
}

size_t Buffer::IFindLast(const char *string) const
{
    assert(string);
    return _IFindBefore(string, length(), strlen(safestr(string)));
}

size_t Buffer::IFindLast(const Buffer &string, size_t beforeOffset) const
{
    return _IFindBefore(string.c_str(), min_clamp0(beforeOffset, length()), string.length());
}

size_t Buffer::IFindLast(const char *string, size_t beforeOffset) const
{
    assert(string);
...
Buffer &Buffer::IReplaceFirst(char replaceThis, char withThis)
{
...
Buffer &Buffer::IReplaceLast(char replaceThis, char withThis)
{
    char tmp[2] = { replaceThis, '\0' };
...
Buffer &Buffer::IReplaceAll(char replaceThis, char withThis, size_t fromOffset)
{
    char tmp[2] = { replaceThis, '\0' };
...
Buffer &Buffer::IReplace(char replaceThis, char withThis, unsigned int maxReplaceCount,
        size_t fromOffset)
{
    char tmp[2] = { replaceThis, '\0' };
...
Buffer &Buffer::IReplaceFirst(const char *replaceThis, const char *withThis)
{
...
Buffer &Buffer::IReplaceLast(const char *replaceThis, const char *withThis)
{
    if (!replaceThis || !withThis)
        return *this;
...
Buffer &Buffer::IReplaceAll(const char *replaceThis, const char *withThis,
        size_t fromOffset)
{
    if (!replaceThis || !withThis || IFindFirst(replaceThis) == NotFound)
        return *this;
...
Buffer &Buffer::IReplace(const char *replaceThis, const char *withThis,
...
size_t Buffer::_IFindAfter(const char *string, size_t offset, size_t /*strlen*/) const
{
    // TODO  honor len
...
size_t Buffer::_IFindBefore(const char *string, size_t offset, size_t strlen) const
{
...
int ICompare(const Buffer &string1, const Buffer &string2)
{
