...
XSFileOutPCStitch::XSFileOutPCStitch(std::ostream& file, ProgressFn* progressFn, void* handle)
...
XSFileInPCStitch::XSFileInPCStitch(std::istream& file, ProgressFn* progressFn, void* handle)
