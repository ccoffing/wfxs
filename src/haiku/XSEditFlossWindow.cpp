...
XSEditFlossWindow::XSEditFlossWindow(XSDocument *document,
        XSFlossPalette const &flossPalette) :
    BAF::Window(BRect(), "Floss Palette",
    ...
    m_save(false)
{
    ...
    BAF::Box *topview = new BAF::Box(NULL, B_PLAIN_BORDER, -1,
            new BAF::VGroup(B_ALIGN_LEFT,
                    new BAF::StringView("Current Floss Palette"),
                    ...
                    new BAF::HGroup(B_ALIGN_TOP,
                            ...
                            new BAF::Box("Palette Editor", B_FANCY_BORDER, -1,
                                    new BAF::HGroup(B_ALIGN_MIDDLE,
                                            ...
                                            // new BAF::PictButton(a "X" button, to remove this entry.
                                            0
                                            )
                                    ),
                            0
